...
const fetchFooterData = async () => {
  ...
  const heroImageScale = useRef(new Animated.Value(1.1)).current;
  ...
  useEffect(() => {
    ...
    if (isHomePage) {
      ...
      heroImageOpacity.setValue(0);

      heroImageScale.setValue(1.1);

      heroTextOpacity.setValue(0);

      heroTextTranslateY.setValue(30);
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.homeHero, isPhoneScreen && { minHeight: 400 }]}>
            ...
            <Animated.View style={[
              ...
              styles.homeHeroContent, 

              isPhoneScreen && { padding: 16, paddingBottom: 40 },
              ...
              <Text style={[styles.homeHeroTitle, {
                ...
                color: isUserDarkMode ? '#fff' : '#fff',

                fontSize: isPhoneScreen ? 24 : 36

              }]}>
                <Text style={{ color: '#008000' }}>K.E</Text>
                {'\n'}
                <Text style={{ color: '#008000' }}>GREEN HEALTH</Text>
                {' '}
                <Text style={{ color: '#18477a' }}>CLINIC</Text>
              </Text>

              <Text style={[styles.homeHeroSubtitle, {

                color: isUserDarkMode ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.9)',

                fontSize: isPhoneScreen ? 14 : 18

              }]}>Center for Functional & Metabolic Medicine</Text>

              <Pressable style={[styles.homeHeroButton, isPhoneScreen && { paddingVertical: 12, paddingHorizontal: 24 }]} onPress={() => setCurrentPage('shop')}>

                <Text style={[styles.homeHeroButtonText, isPhoneScreen && { fontSize: 12 }]}>EXPLORE SERVICES</Text>
